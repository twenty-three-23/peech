...
public class STTController implements SwaggerSTTController{
    ...
    @Override
    public Mono<STTResultResponseDto> responseSTTResult(@ModelAttribute STTRequestDto request, @PathVariable("themeId") Long themeId, @LoginUserId UserIdDTO userId){
    ...
    @Override
    public Mono<STTResultResponseDto> responseSTTResult(@ModelAttribute STTRequestDto request, @PathVariable("themeId") Long themeId, @PathVariable("scriptId") Long scriptId, @LoginUserId UserIdDTO userId){
